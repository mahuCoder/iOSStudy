//
//  YXYPresentationRightController.m
//  iOSStudy
//
...
@interface YXYPresentationRightController ()

@property (nonatomic,strong) UIVisualEffectView *visualView;

@end

@implementation YXYPresentationRightController
...
- (void)presentationTransitionWillBegin {
    ...
    _visualView.alpha = 0.6;
    _visualView.backgroundColor = [UIColor blackColor];
    
    [self.containerView addSubview:_visualView];
    [_visualView addGestureRecognizer:[[UITapGestureRecognizer alloc] initWithTarget:self action:@selector(dismissVC)]];
}
- (void)dismissVC
 {
