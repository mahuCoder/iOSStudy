...
#import "YXYThrid_MapVC.h"

@interface YXYThrid_MapVC ()<UITableViewDelegate, UITableViewDataSource>
{
...
@implementation YXYThrid_MapVC

- (void)viewDidLoad {
    [super viewDidLoad];
    self.arrayData = @[@"百度地图"];
    self.arrayVC = @[@"YXYThrid_BaiduMapRootVC", @"", @"", @"", @"", @"", @""];
