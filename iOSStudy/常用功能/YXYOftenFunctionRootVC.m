...
@interface YXYOftenFunctionRootVC ()<UITableViewDelegate, UITableViewDataSource>
{
...
@implementation YXYOftenFunctionRootVC

- (void)viewDidLoad {
    [super viewDidLoad];
    self.navigationItem.title = @"常用功能";
    self.arrayData = @[@"指纹登录",@"倒计时动画"];
    self.arrayVC = @[@"YXYOfenFimction_TouchLoginVC", @"", @"", @"", @"", @"", @""];
