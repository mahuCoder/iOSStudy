//
//  YXYIosBasic_UITableViewInsetGrouped.m
//  iOSStudy
//
...
#import "YXYIosBasic_UITableViewInsetGrouped.h"

@interface YXYIosBasic_UITableViewInsetGrouped ()<UITableViewDelegate, UITableViewDataSource>
@property (nonatomic, strong) UITableView *tableView;
@property (nonatomic, strong) NSArray *arrayData;
@end

@implementation YXYIosBasic_UITableViewInsetGrouped
