...
- (void)viewDidLoad {
    ...
    self.arrayVC = @[@"YXYIosBasic_UIRootVC",@"YXYIosBasic_lifeCycleVC", @"YXYIosBasic_blockVC", @"", @"", @"", @"", @"",@"", @"", @"https://github.com/smalldu/IOS-Animations",@"", @"", @"", @"",@"",@"https://github.com/smalldu/IOS-Animations",@"YXYIosBasic_otherVC"];
